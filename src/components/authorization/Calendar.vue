...
export default {
  ...
  const attendanceData = {
    ...
    punch_out: punchOut.toISOString(), // Ora convertita a ISO per il backend
  ...
  console.log('Payload inviato al server:', attendanceData); // Debug del payload
  ...
  if (this.selectedEventId) {
    ...
    axios
      ...
      .then((response) => {
        console.log('Risposta dal server:', response.data); // Debug della risposta
        this.fetchAttendanceData();
        this.clearForm();
      })
      .catch((error) => {
