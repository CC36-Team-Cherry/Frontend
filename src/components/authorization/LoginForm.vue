...
const handleLogin = () => {
  ...
  authStore.login({ id: 2, first_name: 'name', last_name: 'last', email: email.value, is_admin: false, is_supervisor: false, company_id: 1, team_id: 1, team_name: "team", role: "leader", join_date: new Date(2020-12-2), pto: 8 });
  loginFirebase();
};
