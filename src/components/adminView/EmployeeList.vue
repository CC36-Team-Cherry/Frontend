    ...
    <Modal :isVisible="isAddUserModalVisible" @close="closeAddUserModal">
      ...
      <form @submit.prevent="submitNewUserForm">
        <div class="grid grid-cols-2 gap-4">
          <!-- First Name -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.firstName') }}</label>
            <input
              type="text"
              v-model="formData.firstName"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.firstName')"
            />
          </div>
          <!-- Last Name -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.lastName') }}</label>
            <input
              type="text"
              v-model="formData.lastName"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.lastName')"
            />
          </div>
          <!-- Email -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.email') }}</label>
            <input
              type="email"
              v-model="formData.email"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.email')"
            />
          </div>
          <!-- Date of Birth -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.dateOfBirth') }}</label>
            <input
              type="date"
          ...
          <!-- Team -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.team') }}</label>
            <input
              type="text"
              v-model="formData.team"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.selectTeam')"
            />
          </div>
          <!-- Supervisor -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.supervisor') }}</label>
            <input
              type="text"
              v-model="formData.supervisor"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.supervisor')"
            />
          </div>
          <!-- Role -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.role') }}</label>
            <input
              type="text"
              v-model="formData.role"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.role')"
            />
          </div>
          <!-- Join Date -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.joinDate') }}</label>
            <input
              type="date"
          ...
          <!-- Type -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.type') }}</label>
            <select v-model="formData.type" class="border border-gray-300 rounded p-2 w-full">
          ...
          <!-- PTO -->
          <div>
            <label class="block mb-1 font-bold">{{ $t('employeeList.modal.fields.pto') }}</label>
            <input
              type="number"
              v-model="formData.pto"
              class="border border-gray-300 rounded p-2 w-full"
              :placeholder="$t('employeeList.modal.placeholders.pto')"
            />
          </div>
        </div>
        <!-- Submit Button -->
...
const openCalendarModal = (employee) => {
  selectedEmployee.value = employee;
